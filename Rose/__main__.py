...
#new end   
    ...
    try:
        ...
        pass
    try:
            await app2.join_chat("Kutty_Angel_Bot_Group")
            await app2.join_chat("Kutty_Angel_Bot_Channel")
    ...
    [
        [
            InlineKeyboardButton(
                text=" 𝐂𝐎𝐌𝐌𝐀𝐍𝐃𝐒 𝐌𝐄𝐍𝐔 ", callback_data="bot_commands"
            ),
        ],
        [
           InlineKeyboardButton(
                text=" 𝐒𝐔𝐏𝐏𝐎𝐑𝐓 ", url="https://t.me/Kutty_Angel_Bot_Group"
            ),
            InlineKeyboardButton(
                text=" 𝐔𝐏𝐃𝐀𝐓𝐄𝐒 ", url="https://t.me/Kutty_Angel_Bot_Channel"
            ),
        ],
        [
            InlineKeyboardButton(
...
start_text = f"""
𝐇𝐈 𝐓𝐇𝐄𝐑𝐄 𝐈'𝐌 [🧚 𝙆𝙐𝙏𝙏𝙔 𝘼𝙉𝙂𝙀𝙇 🧚](https://telegra.ph/file/e41466544aa55f9cf0d64.jpg)
𝐀𝐍 𝐀𝐃𝐕𝐀𝐍𝐂𝐄𝐃 𝐌𝐔𝐒𝐈𝐂 & 𝐆𝐑𝐎𝐔𝐏 𝐌𝐀𝐍𝐀𝐆𝐄𝐌𝐄𝐍𝐓 𝐁𝐎𝐓
𝐓𝐎 𝐏𝐑𝐎𝐓𝐄𝐂𝐓 𝐘𝐎𝐔𝐑 𝐆𝐑𝐎𝐔𝐏 
𝐁𝐘 𝐀𝐃𝐃𝐈𝐍𝐆 𝐌𝐄!
𝐏𝐎𝐖𝐄𝐑𝐄𝐃 𝐁𝐘 :- @ONLY_DUSKY.
"""
...
✘ Base commands are the basic tools of 𝐊𝐔𝐓𝐓𝐘 𝐀𝐍𝐆𝐄𝐋 which help you to [manage](https://telegra.ph/file/e41466544aa55f9cf0d64.jpg)
your group easily and effectivelyYou can choose 
an option below, by clicking a button.
Also you can ask anything in [Support channel](https://t.me/Kutty_Angel_Bot_Channel).
...
You can choose an option below, by clicking a button.
Also you can ask anything in [𝐊𝐔𝐓𝐓𝐘 𝐀𝐍𝐆𝐄𝐋](https://telegra.ph/file/e41466544aa55f9cf0d64.jpg).
...
started time - `2022 {dater}:{timer} `         
        ...
        return await message.reply(
            "**Hey, @KuttyAngelXPlus_bot here :) PM me if you have any questions how to use me!**", reply_markup=keyboard
        )
...
keyboar = InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(
                            text=" 𝐁𝐀𝐒𝐈𝐂 𝐌𝐄𝐍𝐔 ", callback_data="basic_menu"
                        ),
                        InlineKeyboardButton(
                            text=" 𝐀𝐃𝐕𝐀𝐍𝐂𝐄𝐃 𝐌𝐄𝐍𝐔 ", callback_data="adv_menu"
                        ),
                    ],
                    [
                        InlineKeyboardButton(
                            text=" 𝐄𝐗𝐏𝐄𝐑𝐓 ", callback_data="ftools_back"
                        ),
                        InlineKeyboardButton(
                            text=" 𝐈𝐍𝐋𝐈𝐍𝐄 ", callback_data="_inline"
                        ),
                    ],
                    [
                        InlineKeyboardButton(
                            text=" 𝐇𝐎𝐖 𝐓𝐎 𝐔𝐒𝐄 𝐊𝐔𝐓𝐓𝐘 𝐀𝐍𝐆𝐄𝐋 ", callback_data="_how"
                        ),
                        InlineKeyboardButton(
                            text=" 𝐀𝐁𝐎𝐔𝐓 ", callback_data="_about"
                        ),
                    ],
                    [
                        InlineKeyboardButton(
                    ...
                    [
                        InlineKeyboardButton(" 𝐕𝐂-𝐏𝐋𝐀𝐘𝐄𝐑 ", callback_data="_vc")
                    ],

                        [InlineKeyboardButton(text=" 𝐂𝐋𝐎𝐒𝐄 ", callback_data="bot_commands")],
                ]
            )
...
You can choose an option below, by clicking a button.
Also you can ask anything in Support Group[.](https://telegra.ph/file/e41466544aa55f9cf0d64.jpg)
"""
    ...
    if not keyboard:
         keyboard = InlineKeyboardMarkup(
                [
                    ...
                    [
                        InlineKeyboardButton(
                            text=" 𝐄𝐗𝐏𝐀𝐍𝐃 𝐌𝐄𝐍𝐔 ", callback_data="expand_"
                        )
                    ],
                        [InlineKeyboardButton(text="🔙 𝐁𝐀𝐂𝐊 ", callback_data="startcq")],
                ]
            )
...
I'm Kutty Angel group management bot with some useful features.
You can choose an option below, by clicking a button[🧚](https://telegra.ph/file/e41466544aa55f9cf0d64.jpg).
Also you can ask anything in 𝐊𝐔𝐓𝐓𝐘 𝐀𝐍𝐆𝐄𝐋.
""".format(
            first_name=name,
            bot_name=BOT_NAME,
        ),
    ...
    if mod_match:
        ...
        await query.message.edit(
            ...
            reply_markup=InlineKeyboardMarkup(
                [[InlineKeyboardButton("🔙 𝐁𝐀𝐂𝐊 ", callback_data="help_back")]]
            ),
            disable_web_page_preview=True,
        )
    elif home_match:
...
async def help_button(client, query):
    ...
    if mod_match:
            ...
            await query.message.edit_text(
                ...
                disable_web_page_preview=True,
                reply_markup=InlineKeyboardMarkup(
                    [[InlineKeyboardButton(text="🔙 𝐁𝐀𝐂𝐊 ", callback_data="ftools_back")]]
                ),
            )
    elif prev_match:
            curr_page = int(prev_match.group(1))
...
async def help_button(client, query):
    ...
    if mod_match:
            ...
            await query.message.edit_text(
                ...
                disable_web_page_preview=True,
                reply_markup=InlineKeyboardMarkup(
                    [[InlineKeyboardButton(text="🔙 𝐁𝐀𝐂𝐊 ", callback_data="advt_back")]]
                ),
            )
    elif prev_match:
            curr_page = int(prev_match.group(1))
...
async def help_button(client, query):
    ...
    if mod_match:
            ...
            await query.message.edit_text(
                ...
                disable_web_page_preview=True,
                reply_markup=InlineKeyboardMarkup(
                    [[InlineKeyboardButton(text="🔙 𝐁𝐀𝐂𝐊 ", callback_data="basict_back")]]
                ),
            )
    elif prev_match:
            curr_page = int(prev_match.group(1))
...
𝐊𝐔𝐓𝐓𝐘 𝐀𝐍𝐆𝐄𝐋 supports a large number of formatting options 
...
BTTON_1 = InlineKeyboardMarkup(
        ...
        [
        InlineKeyboardButton('Bug Report', url="https://t.me/Kutty_Angel_Bot_Channel")
        ],
        [InlineKeyboardButton('🔙 𝐁𝐀𝐂𝐊 ', callback_data='bot_commands')
        ]]
...
BUTTON_20 = InlineKeyboardMarkup(
        [[
        InlineKeyboardButton("🔙 𝐁𝐀𝐂𝐊  ", callback_data="for_commands"),
        ]]
...
async def commands_callbacc(_, CallbackQuery):
    ...
    TEXT_PART = f"""
@KuttyAngelXPlus_bot ** is one of the fastest and most feature filled group manager**.   
 
 - **Latest Update Time** : `2022 {dater}:{timer}`
 - **Modules Loaded **:  `{modules_count}`
 - **Globally banned users.** :  `{gbans}`
@KuttyAngelXPlus_bot **Mongo database stats**
 - ** Users ** : `{served_users}`
 - ** chats.** : `{served_chats}`
...
TEXT_PART_1 = """
**Welcome to the 𝐊𝐔𝐓𝐓𝐘 𝐀𝐍𝐆𝐄𝐋 Configuration**
The first thing to do is to add 𝐊𝐔𝐓𝐓𝐘 𝐀𝐍𝐆𝐄𝐋 Bot ✨ to your group! 
...
▫️ Add @KuttyAngelXPlus_bot as Admin
...
BUTTON_1 = InlineKeyboardMarkup(
        [[        
        InlineKeyboardButton('🧚 𝐀𝐃𝐃 𝐊𝐔𝐓𝐓𝐘 𝐀𝐍𝐆𝐄𝐋 𝐓𝐎 𝐂𝐇𝐀𝐓! 🎉', url='https://t.me/KuttyAngelXPlus_bot?startgroup=new')
        ],
        [InlineKeyboardButton(' 𝐃𝐎𝐍𝐄 ✅', callback_data="next_1")
        ]]
...
BUTTON_2 = InlineKeyboardMarkup(
        [[
        InlineKeyboardButton(' 𝐃𝐎𝐍𝐄 ✅', callback_data="next_2"),
        ]]
...
BUTTON_3 = InlineKeyboardMarkup(
        [[
        InlineKeyboardButton(' 𝐂𝐎𝐍𝐓𝐈𝐍𝐔𝐄 ✅', callback_data="bot_commands"),
        ]]
...
𝐊𝐔𝐓𝐓𝐘 𝐀𝐍𝐆𝐄𝐋 ✨ is developed and actively maintained by @ONLY_AJAY & @ONLY_DUSKY.

𝐊𝐔𝐓𝐓𝐘 𝐀𝐍𝐆𝐄𝐋 has been online since 2022/3/31 and have many [groups and users.](https://t.me/Kutty_Angel_Bot_Group)
...
**Current Version:** `1.0.6` | [Special Credits](https://t.me/Kutty_Angel_Bot_Group)
"""
...
TEXT_PAT_1 = """
**Welcome to the 𝐊𝐔𝐓𝐓𝐘 𝐀𝐍𝐆𝐄𝐋 Configuration**
The first thing to do is to add 𝐊𝐔𝐓𝐓𝐘 𝐀𝐍𝐆𝐄𝐋 ✨ to your group! 
For doing that, press the under button and select your group,
then press Done to continue the tutorial..
"""
...
All commands can be used with / 
If you're facing any difficulties in setting up me in your group, 
so don't hesitate to come in @KuttyAngelXPlus_bot.
We would love to help you.
"""
...
BUTON_1 = InlineKeyboardMarkup(
        [[        
        InlineKeyboardButton('🧚 𝐀𝐃𝐃 𝐊𝐔𝐓𝐓𝐘 𝐀𝐍𝐆𝐄𝐋 𝐓𝐎 𝐂𝐇𝐀𝐓! 🎉', url='http://t.me/KuttyAngelXPlus_bot?startgroup=new')
        ],
        [InlineKeyboardButton(' 𝐃𝐎𝐍𝐄 ✅', callback_data="next_100")
        ]]
...
BUTON_2 = InlineKeyboardMarkup(
        [[
        InlineKeyboardButton(' 𝐃𝐎𝐍𝐄 ✅', callback_data="next_200"),
        ]]
